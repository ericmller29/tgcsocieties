...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="description" content="TGCSocieties is an online manager for The Golf Club 2 society presidents. Create tournaments, and share your leaderboard anywhere you'd like!">
